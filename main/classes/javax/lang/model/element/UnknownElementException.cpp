...
UnknownElementException::UnknownElementException(const UnknownElementException& e) {
}

UnknownElementException UnknownElementException::wrapper$() {
	$pendingException(this);
	return *this;
}

void UnknownElementException::throwWrapper$() {
	$pendingException(this);
	throw *this;
}
